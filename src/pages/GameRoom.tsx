// Enhanced GameRoom.tsx with elegant UI & animation and fixed Supabase logic
...
const GameRoom: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-white bg-gradient-to-b from-black via-gray-900 to-black p-6">
      ...
      <motion.div className="text-sm text-gray-400 mb-4" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
